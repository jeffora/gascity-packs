...
`gc.work_dir` is the launcher rig root, not the implementation worktree. The artifact-validation gate runs
automatically from `gc.work_dir`; you do not invoke it yourself.
